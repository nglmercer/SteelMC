//! ZombieNautilus entity - vanilla `{java_class}`.
...
use steel_registry::vanilla_entity_data::ZombieNautilusEntityData;
...
pub struct ZombieNautilusEntity {
    ...
    mob_base: MobBase,
    entity_data: steel_utils::locks::SyncMutex<ZombieNautilusEntityData>,
}
