...
use crate::entity::ai::goal::{
    AvoidEntityGoal, FloatGoal, LookAtPlayerGoal, MeleeAttackGoal, RandomLookAroundGoal,
...
/// Vanilla creeper. See `Creeper.java:64`.
...
pub struct CreeperEntity {
    ...
    mob_base: MobBase,
    entity_data: steel_utils::locks::SyncMutex<CreeperEntityData>,
}
...
impl CreeperEntity {
    ...
    fn new_with_base(base: EntityBase, entity_type: EntityTypeRef) -> Self {
        ...
        let mob_base = MobBase::new();
        {
            ...
            goals.add_goal(4, MeleeAttackGoal::new(1.0, false));
            goals.add_goal(5, WaterAvoidingRandomStrollGoal::new(0.8));
