//! TraderLlama entity - vanilla `{java_class}`.
...
use steel_registry::vanilla_entity_data::TraderLlamaEntityData;
...
pub struct TraderLlamaEntity {
    ...
    mob_base: MobBase,
    entity_data: steel_utils::locks::SyncMutex<TraderLlamaEntityData>,
}
