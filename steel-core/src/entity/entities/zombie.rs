...
use crate::entity::ai::goal::{
    FloatGoal, LookAtPlayerGoal, MeleeAttackGoal, RandomLookAroundGoal,
...
pub struct ZombieEntity {
    ...
    mob_base: MobBase,
    entity_data: steel_utils::locks::SyncMutex<ZombieEntityData>,
}

// SAFETY: key is Steel-owned and unique for this concrete type.
...
impl ZombieEntity {
    ...
    fn new_with_base(base: EntityBase, entity_type: EntityTypeRef) -> Self {
        ...
        // Vanilla Zombie: Float, Melee, stroll, look goals. See Zombie.java:112
        {
        ...
        {
            // DEFERRED: HurtByTargetGoal and NearestAttackableTargetGoal not yet ported
