...
mod tests {
    ...
    fn dummy_factory_outcomes_keep_proto_and_full_stage_semantics() {
        ...
        // A jigsaw block stands in for `BlockEntityCreation::Unimplemented`: it has a
        // vanilla block entity type but no Steel factory yet. Swap it for another
        // still-unimplemented block entity block once jigsaws are implemented.
