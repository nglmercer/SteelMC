...
fn furnace_use(
    ...
    let Some(container_ref) = ContainerRef::from_block_entity(be) else {
        return InteractionResult::Pass;
    };
    let inventory = player.inventory.clone();
    player.open_menu(title, move |ctx| {
        menu_fn(inventory, ctx.container_id, container_ref)
    });
...
impl BlockBehavior for FurnaceBlock {
    ...
    fn use_without_item(
        ...
        furnace_use(
            ...
            pos,
            player,
            crate::inventory::menu::kinds::furnace,
    ...
    fn get_analog_output_signal(
        ...
        guard
            ...
            .map_or(0, |c| calculate_redstone_signal_from_container(c))
    }
...
impl BlockBehavior for SmokerBlock {
    ...
    fn use_without_item(
        ...
        furnace_use(
            ...
            pos,
            player,
            crate::inventory::menu::kinds::smoker,
...
impl BlockBehavior for BlastFurnaceBlock {
    ...
    fn use_without_item(
        ...
        furnace_use(
            ...
            pos,
            player,
            crate::inventory::menu::kinds::blast_furnace,
